...
// in the fd table a fork copies. That is the guarantee writeExecutable needs,
// and taking the read lock is the documented way to ask for it — see the
// ForkLock comment in the standard library's syscall/exec_unix.go.
